...
st.sidebar.subheader('Visualization using seaborn and plotly by pdm07')
...
# correlation heatmap
st.subheader('Heatmap between correlated and semi-normal variables')
...
sns.heatmap(correlations,xticklabels=df2.columns,yticklabels=df2.columns,cmap='coolwarm',annot=True,vmin=-1, vmax=1.0)
plt.show()
st.pyplot()
